...
export class AssignmentPage {
 ...
 whatsappnumber = "8817546511";
  url : string = "https://wa.me/"+this.countrycode+this.whatsappnumber+"?text=Hi {{userDetail.fullname}}, You have been assigned to task Id - <no>. Please check in CRM app for more details. Regards, CRM Admin";
}
